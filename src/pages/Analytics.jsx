  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{t('analytics_reports', 'Analytics & Reports')}</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">{t('analytics_desc', 'Deep dive into your donation metrics and user growth.')}</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-[#171921] p-6 rounded-xl border border-gray-100 dark:border-[#262833] shadow-sm">
          <p className="text-sm font-medium text-gray-500 dark:text-gray-400">{t('total_donations_year', 'Total Donations (Year)')}</p>
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-3xl font-bold text-gray-900 dark:text-gray-100">$124,500</span>
        ...
        <div className="bg-white dark:bg-[#171921] p-6 rounded-xl border border-gray-100 dark:border-[#262833] shadow-sm">
          <p className="text-sm font-medium text-gray-500 dark:text-gray-400">{t('new_donors_month', 'New Donors (Month)')}</p>
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-3xl font-bold text-gray-900 dark:text-gray-100">1,240</span>
            <span className="text-xs font-semibold text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-950/50 px-1.5 py-0.5 rounded flex items-center">
        ...
        <div className="bg-white dark:bg-[#171921] p-6 rounded-xl border border-gray-100 dark:border-[#262833] shadow-sm">
          <p className="text-sm font-medium text-gray-500 dark:text-gray-400">{t('case_resolution_rate', 'Case Resolution Rate')}</p>
          <div className="mt-2 flex items-baseline gap-2">
            <span className="text-3xl font-bold text-gray-900 dark:text-gray-100">94.2%</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Line Chart */}
        <div className="bg-white dark:bg-[#171921] p-6 rounded-xl border border-gray-100 dark:border-[#262833] shadow-sm">
          <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-6">{t('user_growth_vs_donations', 'User Growth vs Donations')}</h3>
        ...
        {/* Pie Chart */}
        <div className="bg-white dark:bg-[#171921] p-6 rounded-xl border border-gray-100 dark:border-[#262833] shadow-sm">
          <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-6">{t('blood_type_distribution', 'Blood Type Distribution')}</h3>
          <div className="h-80 w-full" dir="ltr">
            <ResponsiveContainer width="100%" height="100%" minWidth={0}>
              <PieChart>
                <Pie
