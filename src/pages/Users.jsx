      ...
      <div className="bg-white dark:bg-[#171921] rounded-xl border border-gray-100 dark:border-[#262833] shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-gray-50 dark:bg-[#0f1117] border-t border-gray-100 dark:border-[#262833]">
          ...
          <div className="flex gap-2">
            <button className="px-3 py-1 text-sm border border-gray-200 dark:border-[#262833] rounded bg-white dark:bg-[#171921] text-gray-400 cursor-not-allowed">
              {t("previous", "Previous")}
            </button>
            <button className="px-3 py-1 text-sm border border-gray-200 dark:border-[#262833] rounded bg-white dark:bg-[#171921] text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#1c1e27]">
              {t("next", "Next")}
            </button>
          </div>
        </div>
